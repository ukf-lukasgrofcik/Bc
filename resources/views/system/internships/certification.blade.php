        ...
        <div class="col-xl-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <form action="{{ route('internships.certification.upload', $internship) }}" method="post" enctype="multipart/form-data">
                        @include('system.internships._partials._certification_form')
                    </form>
                </div>
            </div>
        </div>
